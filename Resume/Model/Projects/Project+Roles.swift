...
extension Project {
	...
	var roles: [Role] {
		...
		case .sdkV2: return [.developer([.iOS, .documentation, .unitTests])]
		case .panacast: return [.lead([.android, .documentation])]
		case .tinget: return [.lead([.iOS, .documentation])]
		case .lunar: return [.developer([.android, .backend(.node), .unitTests])]
		...
		case .spike: return [.developer([.iOS, .web(.react), .backend(.node), .unitTests])]
		case .mitYouSee: return [.developer([.iOS, .unitTests])]
		case .bolig: return [.developer([.iOS])]
		case .issuu: return [.developer([.iOS])]
		case .sdk: return [.architect, .developer([.iOS, .documentation, .unitTests])]
